...
Usage:
    .venv/bin/python pointcloud/make_pointcloud.py                       # newest capture only
    .venv/bin/python pointcloud/make_pointcloud.py captures/2026..       # one specific capture
    .venv/bin/python pointcloud/make_pointcloud.py captures/A captures/B # several captures
    .venv/bin/python pointcloud/make_pointcloud.py --all                 # EVERY capture folder
...
def all_captures():
    ...
    if not folders:
        sys.exit("No captures found. Run camera/capture.py, or wasd/drive.py and press V.")
    return folders
